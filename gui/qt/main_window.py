...
from scallop.i18n import _, set_language
from scallop.util import print_error, print_msg
...
from scallop.bitcoin import MIN_RELAY_TX_FEE, is_valid
from scallop.plugins import run_hook

import icons_rc

from scallop.util import format_satoshis, format_time, NotEnoughFunds, StoreDict
from scallop import Transaction
from scallop import mnemonic
from scallop import util, bitcoin, commands, Interface, Wallet
from scallop import SimpleConfig, Wallet, WalletStorage
from scallop import Imported_Wallet
...
from scallop import ELECTRUM_VERSION
import re
...
from scallop.paymentrequest import PR_UNPAID, PR_PAID, PR_EXPIRED
from scallop.paymentrequest import PaymentRequest, InvoiceStore, get_payment_request, make_payment_request
...
class ElectrumWindow(QMainWindow):
    ...
    def __init__(self, config, network, gui_object):
        ...
        self.setWindowIcon(QIcon(":icons/scallop.png"))
        self.init_menubar()
    ...
    def settings_dialog(self):
        ...
        from scallop.i18n import languages
    ...
    def plugins_dialog(self):
        from scallop.plugins import plugins
